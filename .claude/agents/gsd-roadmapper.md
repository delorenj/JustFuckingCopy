...
Reference full template: `/home/delorenj/code/JustFuckingCopy/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/delorenj/code/JustFuckingCopy/.claude/get-shit-done/templates/state.md`.
